package com.wpisen.trace.agent.test.jdbc;
...
public class JdbcCommonCollects extends AbstractByteTransformCollect {
    ...
    static {
        // connect
        beginSrc = "com.wpisen.trace.agent.test.jdbc.JdbcCommonCollects inst=com.wpisen.trace.agent.test.jdbc.JdbcCommonCollects.INSTANCE;";
