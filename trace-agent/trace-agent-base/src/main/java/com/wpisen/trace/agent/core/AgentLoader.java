...
import com.wpisen.trace.agent.common.util.IOUtils;
...
//            HttpAgentProxyHandle.initializeHttp();
    ...
    public CtClass buildAgentClass(String className, ClassLoader loader, List<AgentItemSource> agents) throws NotFoundException,
        ...
        String outlog = String.format("trace anget writeFile %s%s/%s", System.getProperty("user.dir"), CLASS_FILE_TEMP, ctclass
