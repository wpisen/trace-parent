...
import com.wpisen.trace.agent.common.JsonSerializable;
...
public class TraceNode implements Serializable, JsonSerializable {
    ...
    public String getInHeaderParam() {
		return inHeaderParam;
	}
	public void setInHeaderParam(String inHeaderParam) {
		this.inHeaderParam = inHeaderParam;
	}
    ...
    public String toString() {
        ...
        sb.append(", inHeaderParam='").append(inHeaderParam).append('\'');
