...
public class DevelopBootMain {
    ...
    public static void premain(String agentArgs, Instrumentation inst) throws Exception {
        ...
        Properties config = AgentBootMain.loadLocalProperties(defaultProperties,"/conf/trace_dev.properties");
        ...
        System.err.println("trace 开发服务启动成功 ");
    }

    private static TraceSessionInfo mockSession(Properties config) {
        ...
        session.setClientVersion(config.getProperty("mock.version","trace-agent_V1.1.2"));
