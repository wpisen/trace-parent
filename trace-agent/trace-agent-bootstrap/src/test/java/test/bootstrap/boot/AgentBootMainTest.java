...
import com.wpisen.trace.agent.bootstrap.AgentBootMain;
import com.wpisen.trace.agent.bootstrap.BytesHexStrTranslate;
import com.wpisen.trace.agent.bootstrap.TraceSessionInfo;
import com.wpisen.trace.agent.bootstrap.JaxbUtil;
import com.wpisen.trace.agent.bootstrap.UtilEncryption;
...
public class AgentBootMainTest {
    ...
    public void TestOpenSuccess() {
        ...
        String fastjson = "/Users/wpisen/git/trace-agent/out/fastjson-1.1.23.jar";
	...
	public URL createSession() throws IOException {
        URL result;
        URL url = new URL("file:/Users/wpisen/git/trace-agent/out/trace-agent-base-1.0.0.jar");
        ...
        File f = new File("/Users/wpisen/git/trace-agent/out/mockSession.xml");
    ...
    public void clientMd5Create() throws IOException {
        String file="C:\\Users\\gc\\Desktop\\1\\trace-agent-base-1.0.0.jar";
        byte[] bytes = Files.readAllBytes(new File(file).toPath());
        System.out.println(BytesHexStrTranslate.bytesToHexFun1(bytes));
