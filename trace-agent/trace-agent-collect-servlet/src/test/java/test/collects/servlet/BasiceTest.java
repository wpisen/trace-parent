...
public class BasiceTest {
	...
	public BasiceTest() {
		...
		/*
		 * try { loader.loadItemByJar(new File(System.getProperty("user.dir") +
		 * "/target/trace-agent-collects-1.0.0.jar").toURL()); } catch
		 * (Exception e) { throw new RuntimeException(e); }
		 */
		// AgentFinal.LOCAL_CONFIG.setProperty(
		// AgentFinal.FAST_JSON_URL,"file:/Users/wpisen/git/trace-agent/out/fastjson-1.1.23.jar");
	...
	public List<AgentItemSource> loadAgentItems(String className, String handClass, String srcTemplate,
