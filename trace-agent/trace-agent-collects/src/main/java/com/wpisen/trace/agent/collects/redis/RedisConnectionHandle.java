package com.wpisen.trace.agent.collects.redis;
...
import com.wpisen.trace.agent.collect.CollectHandle;
import com.wpisen.trace.agent.collect.Event;
import com.wpisen.trace.agent.collect.EventType;
import com.wpisen.trace.agent.collect.InParams;
import com.wpisen.trace.agent.collect.MethodInfo;
import com.wpisen.trace.agent.collect.OutResult;
 ...
 * 不支持二进制结果集的采集
 * 
 * @author zengguangwei@wpisen.com
 * @version 1.0
...
public class RedisConnectionHandle implements CollectHandle {
    ...
    private void sendCommandToBinaryAfter(Event event, OutResult out, TraceSession session) {
        ...
        node.setResultState(out.error == null ? "success" : "fail");
